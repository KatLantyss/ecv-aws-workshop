...
| Task 5 - S3 整合 | 15-20 mins | 擴充應用整合 S3 上傳/讀取功能 |
| Task 6 - RDS 整合 | 15-20 mins | 擴充應用整合 RDS MySQL 排行榜功能 |
| Task 7 - 資源清除 | 10 mins | 刪除所有 AWS 資源避免產生費用 |
...
:::alert{type="warning"}
本工作坊會建立 RDS、ALB 等計費資源，完成後請務必執行 Task 7 清除所有資源，避免產生額外費用。
:::
