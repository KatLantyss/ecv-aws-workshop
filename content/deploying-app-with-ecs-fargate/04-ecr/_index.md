...
## 3.1 在 Console 確認 ECR Repository
...
3. 確認 `ecs-fargate-lab-app` 存在，目前應該沒有任何映像
:::
...
例如：`export ECR_REPO=123456789012.dkr.ecr.us-east-1.amazonaws.com/ecs-fargate-lab-app`
:::
...
預期看到兩個映像指向同一個 IMAGE ID：`web2048:latest` 和 `<ECR_URI>:nginx`。
...
:::expand{title="預期輸出"}
```
The push refers to repository [123456789012.dkr.ecr.us-east-1.amazonaws.com/ecs-fargate-lab-app]
9fb7edea8440: Pushed
abc66ad258e9: Pushed
...
